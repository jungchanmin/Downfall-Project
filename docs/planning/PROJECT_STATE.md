...
**Phase 4C: 중간 지대 장소 원고 세부 Import**

Phase 4B에서 중심부 및 중심부 근처 4개 장소의 세부 Import를 완료했다. 현재는 중간 지대 4개 장소의 ConfigureBook 원고를 검토하고, 세부 공간·상호작용·이상현상·위협 후보를 Wiki 장소 문서에 선별 반영하는 단계다.
...
- 이상현상과 위협 후보를 고정 사건이 아닌 이벤트 후보로 정리
...
1. Phase 4C 중간 지대 장소 Import PR 검토 및 병합
2. 외곽 및 외곽 심부 Place 원고 세부 Import 패스
...
Phase 4C 작업 완료 후 이 항목을 해당 Draft PR로 갱신한다.
