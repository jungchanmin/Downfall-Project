...
- Skill Catalog SECTION 0 소유권 규칙 원문 병합
- SECTION 1 최신 `R18SkillDef` 스키마 원문 병합
- `required_parts`를 대상 부위와 행동 부위로 분리
- SECTION 5 축 상성의 책임을 친화도 보정으로 축소
- Tease 카운터를 Gate Tag 완전 일치로 제한
- SECTION 7 생존자·괴물별 기술 참조 방식 원문 병합
- SECTION 8 영문 자세·부위 키와 행동 취소 후 주도권 규칙 원문 병합
- 대표 기술 5종을 전원 공용 기술에서 분류 템플릿으로 재해석
- 기존 기술 예시의 레거시 필드 읽기 변환 규칙

## Blockers

- 기존 Skill Catalog 원문 SECTION별 직접 병합 미완료
